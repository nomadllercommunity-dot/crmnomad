...
import { UserPlus, ListPlus, BarChart3, Download, LogOut, MessageCircle, Bell, BookOpen, MapPin } from 'lucide-react-native';
...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: 'Add and manage travel destinations',
      icon: MapPin,
